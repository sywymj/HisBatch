...
namespace CVR100A
{
    ...
    class CVRSDK
    {
        ...
        public static extern int GetPeopelName([MarshalAs(UnmanagedType.LPStr)]StringBuilder strTemp,ref  int strLen);
        [DllImport("termb.dll", EntryPoint = "GetPeopleSex", CharSet = CharSet.Ansi, SetLastError = false)]
        public static extern int GetPeopleSex([MarshalAs(UnmanagedType.LPStr)]StringBuilder strTemp, ref  int strLen);
        [DllImport("termb.dll", EntryPoint = "GetPeopleNation", CharSet = CharSet.Ansi, SetLastError = false)]
        public static extern int GetPeopleNation([MarshalAs(UnmanagedType.LPStr)]StringBuilder strTemp, ref  int strLen);
        [DllImport("termb.dll", EntryPoint = "GetPeopleIDCode", CharSet = CharSet.Ansi, SetLastError = false)]
        public static extern int GetPeopleIDCode([MarshalAs(UnmanagedType.LPStr)]StringBuilder strTemp, ref  int strLen);
